...
public class ContinueFTP {
    ...
    public Map< String,Object > download( String local ) throws Exception {
        connect( PropertiesUtil.getStaticSourceFtpIp(), CommonUtil.toInteger( PropertiesUtil.getStaticSourceFtpPort() ), PropertiesUtil.getStaticSourceFtpUser(),
            PropertiesUtil.getStaticSourceFtpPwd() );
        Boolean is_connect = connect( PropertiesUtil.getStaticSourceFtpIp(), CommonUtil.toInteger( PropertiesUtil.getStaticSourceFtpPort() ),
            PropertiesUtil.getStaticSourceFtpUser(), PropertiesUtil.getStaticSourceFtpPwd() );
