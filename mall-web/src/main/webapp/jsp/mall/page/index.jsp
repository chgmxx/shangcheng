...
<html>
  <head>
	...
	<script type="text/javascript" src="/js/plugin/copy/clipboard.min.js?<%= System.currentTimeMillis()%>"></script>
	<script type="text/javascript" src="/js/plugin/copy/copypublic.js?<%= System.currentTimeMillis()%>"></script>
					...
					<li>
						...
						<div class="listd" style="width:20%;">
							<div class="bianji" style="width: 185px;position:relative;display:inline-block;">
								...
								<a href="javascript:;" class="bj-a copy copy_public" title="复制链接"  data-clipboard-text="${path }/mallPage/${pag.id}/79B4DE7C/viewHomepage.do"  aria-label="复制成功！"></a>
							</div>
