...
.main{width: 870px;margin: 0 auto 100px auto; }
.header{height: 90px; line-height: 90px;font-size: 33px;text-align: center; }
.header .back{ width: 25px; height: 100%;display: inline-block; float: right;position: relative;right: 40px;
 background: url(images/mall/delete.png) no-repeat  50% 50%;}
.address-box{padding: 38px 0px;border-bottom: 1px solid #dfdfdf;border-top: 1px solid #dfdfdf;position: relative;
	margin-bottom: 20px; }
.address-box .main-con{width: 718px;margin: 0 auto;}
.address-box .box{height: 50px;line-height: 50px;display:flex;display:-webkit-flex;}
.address-box .box label{color: #9d9d9d;}
.address-box .box p{margin-left: 90px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;max-width: calc(100% - 200px);}
.address-box .check{display: inline-block;width: 47px;height: 56px;float: left;position: absolute;left: 15px;
    top: 50%;margin-top: -28px;background: url(images/mall/check.jpg) no-repeat center center; }
.address-box .noCheck{display: inline-block;width: 47px;height: 56px;float: left;position: absolute;left: 15px;
    top: 50%;margin-top: -28px;background: url(images/mall/noCheck.png) no-repeat center center; }
.address-box .edit{display: inline-block;width: 57px;height: 51px;float: left;position: absolute;
   right: 20px;top: 50%;margin-top: -25px;background: url(images/mall/edit.jpg) no-repeat center center;}
.footer{position: fixed;bottom: 20px;width: 870px;}
.footer .new-address{width: 828px;height: 83px;margin: 0 auto;display: block;text-align: center;color: #FFFFFF;
   font-size: 35px;background-color:#f23030;border:none;border-radius:12px;-webkit-border-radius: 12px;-moz-border-radius: 12px;
   text-decoration: none;line-height: 83px; }
.isAdvert{position: fixed;bottom: 80px;width:870px;height:auto;}
   ...
   <div class="main">
   		...
   		<c:forEach var="address" items="${addressList }" >
		   	<div class="address-box">
		   		<c:if test="${empty addressManage}">
			   		...
			   		<c:if test="${address.mem_default == 2 }">
		   		...
		   		<div class="main-con">
		   			<div class="box">
		    			<label for="">姓名</label>
		    			<p>${address.mem_name }</p>
		    		</div>
		    		<div class="box">
		    			<label for="">电话</label>
		    			<p>${address.mem_phone }</p>
		    		</div>
		    		<div class="box">
		    			<label for="">地址</label>
		    			<p>${address.pName }${address.cName }${address.mem_address } 
   	...
   	<c:if test="${!empty isAdvert }">
    	<!-- <div class="isAdvert" style="">
    		<div><img alt="" src="/images/jishuzhichi.png"></div>
    	</div> -->
    	<div class="isAdvert" style="">
