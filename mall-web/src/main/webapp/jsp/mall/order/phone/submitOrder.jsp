 ...
 <c:set var="jifenProMoney" value="0"></c:set>
	...
	<div class="delivery_way" style="display: none;" id="delivery_way">
		<ul>
			<li class="flex">
				<div>提货人：</div>
				<div><input type="text" name="appointName" id="appointName" placeholder="请填写提货人姓名" value="${appointName}"/></div>
			</li>
			<li class="flex">
				<div>手机号码：</div>
				<div><input type="tel" name="appointTelphone" id="appointTelphone"  placeholder="请填写提货人手机号码" value="${appointTel}"
					maxlength="11" /></div>
			</li>
