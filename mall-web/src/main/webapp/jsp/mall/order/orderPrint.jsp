...
<style type="text/css">
	*{margin: 0; padding: 0; list-style: none;}
	...
	.order_layer{width: 700px; margin:10px auto; border: 1px solid #dadada; font-size: 13px;background-color: #FFFFFF; z-index: 10005;}
	.order_list li{width: 50%; float: left; font-size: 13px;}
	.order_layer h2{font-size: 18px; text-align: center; width: 100px; border-bottom: 2px solid #000; margin: 0 auto;}
	.order_layer h3{font-size: 13px; text-align: center; font-weight: normal;}
	.order_tab{table-layout: fixed;}
	.order_layer_title{position: relative;}
	.order_layer_title .page_num{position: absolute; right: 5px; top: 2px; font-size: 12px;}
	.fade{position: fixed; width: 100%; height: 100%; background-color: rgba(0,0,0,0.4); z-index: 10002;}
</style>
</head>
<body>
