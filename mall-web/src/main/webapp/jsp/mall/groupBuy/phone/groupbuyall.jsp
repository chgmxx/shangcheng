...
<div class="Warp">
    ...
    <header class="w header">
        ...
        <c:if test="${empty groupName }">团购商品</c:if>
        <%--  <c:if test="${groupId eq null}">  团购商品</c:if>
    ...
    <c:set var="urls" value="/mGroupBuy/${shopid }/79B4DE7C/groupbuyall.do"></c:set>
                            ...
                            <a href="/mallPage/${list.id}/${shopId}/79B4DE7C/phoneProduct.do">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="info-price flex">
                                        <div class="now-price" style="width: auto">
                                                ${list.peopleNum }人拼团价:<span class="price_spans">￥<span class="new-price">${list.price}</span></span>
                                        </div>
                                    </div>
                                    <div class="info-price flex">
                                        <div class="info-price flex width_100">
                                            <div class="old-price price_spans width_100">
                                                <!-- 原价: -->￥ <span>${list.old_price}</span>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function queryurl(type, desc, style, status) {
        ...
        var url = "/mGroupBuy/${shopId}/79B4DE7C/groupbuyall.do?type=" + type + "&desc=" + desc;
        if (style != '') {
            url += "&groupId=" + style;
        }
        if (status == 0) {
