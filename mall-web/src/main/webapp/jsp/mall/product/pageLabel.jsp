	...
	<div class="box-btm30 clearfix">
		<div class="page">
			<div class="fl right-10" id="div-allchoose">
			    ...
			    <a href="javascript:;" class="ui-btn js-batch-tj" >推荐</a>
			    <a href="javascript:;" class="ui-btn js-batch-sctj">删除推荐</a>
			</div>
			...
			<ul>
				...
				<li class="pgfocus"><a href="javascript:page(${page.pageCount},'${page.url }',0);">尾页</a></li>
