...
<link rel="stylesheet" type="text/css" href="css/trade/mall/group.css?<%= System.currentTimeMillis()%>" />
		...
		<form id="groupForm">
			...
			<div class="noMoneyDiv" >
				...
				<div class="groupDiv proPrices" 
					style="<c:if test='${!empty pifa }'><c:if test='${!empty pifa.priceList }'>display:none;</c:if></c:if>" >
...
<script type="text/javascript" src="/js/trade/mall/pifa/pifa_new_inven.js"></script>
</body>
</html>