                ...
                <tr>
                    ...
                    <td>
						<span class="operate" style="position:relative;display:inline-block;">
							...
							<a href="javascript:;" class="bj-a copy copy_public" title="复制链接"  data-clipboard-text="${path }/mallPage/${joinProduct.product_id}/${joinProduct.shop_id }/79B4DE7C/phoneProduct.do?view=show"  aria-label="复制成功！"></a>
						</span>
