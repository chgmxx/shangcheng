...
<link id="link" rel="stylesheet" type="text/css" href="css/trade/mall/shoppingall/index.css" />
<script src="js/jquery-1.8.0.min.js?<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript" src="js/html5shiv.min.js?<%= System.currentTimeMillis()%>"></script>
<!-- 头部分区结束 -->
...
<jsp:include page="/jsp/merchants/trade/mall/customer.jsp"></jsp:include>
</body>
<script>
