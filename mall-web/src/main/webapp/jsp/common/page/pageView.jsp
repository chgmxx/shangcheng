...
<div class="box-btm30 clearfix">
    <div class="page">
        <ul>
            <li class="pgfocus"><a
                    href="javascript:page(1,'');">首页</a></li>
            <li class="pgfocus"><a
                    href="javascript:page(${page.curPage-1},'');">上一页</a></li>
            <li class="pgfocus current">第<c:if test="${page.curPage==0 }">${page.curPage+1 }</c:if>
                <c:if test="${page.curPage != 0 }">${page.curPage }</c:if>页
            </li>
            <li class="pgfocus"><a
                    href="javascript:page(${page.curPage+1},'');">下一页</a></li>
            <li class="pgfocus"><a
                    href="javascript:page(${page.pageCount },'');">尾页</a></li>
...
<script type="text/javascript">
    function page(curPage, url) {
        url = location.origin+location.pathname+"?curPage=";
