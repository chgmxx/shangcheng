...
function addshopping(){
	...
	var data = {shopId : shopid,productId:product_id,productSpecificas:product_specificas,productNum:product_num,productSpeciname:product_speciname,price:price,primaryPrice:primary_price,proCode:pro_code,discount:discount};
	if($(".saleMemberId").length > 0 && saleLen > 0){
		var commission = $(".commission").text();
		if(commission != null && commission != ""){
...
function addshop_ping(){
	...
	var data = {
			shopId : shopid,productId:product_id,productSpecificas:product_specificas,productNum:product_num,productSpeciname:product_speciname,price:price,primaryPrice:primary_price,proCode:pro_code,discount:discount
	};
	if($(".saleMemberId").length > 0 && saleLen > 0){
