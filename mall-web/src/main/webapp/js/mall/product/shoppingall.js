...
$(function(){
	...
	$(".last-item").click(function(){
		...
		if(_href==="css/trade/mall/shoppingall/indexModify2.css"){
			$("#link").attr("href","css/trade/mall/shoppingall/indexModify1.css");
		}
		else{
			$("#link").attr("href","css/trade/mall/shoppingall/indexModify2.css");
		}
    });
	/*左侧菜单切换*/
