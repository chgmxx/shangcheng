...
function pfProductBuy(){
	...
	if(flag){
		...
		var hs = {product_id:product_id,product_specificas:product_specificas,totalnum:product_num,price:price,primary_price:primary_price,discount:discount,isCoupons:isCoupons};
		if(groupBuyId > 0){
