...
function editAuction() {
    ...
    if (type == 1) {//跳转到商品详情
        ...
        if (!reg.test(returnUrl)) {
            parentAlertMsg('这网址不是以http://https://开头，或者不是网址！');
...
function choosePro() {
    ...
    loadWindow();
    parentOpenIframe("选择商品", "600px", "480px", "/mGroupBuy/getProductByGroup.do?defaultProId=" + defaultProId);//check==0代表多选，check==1代表单选
