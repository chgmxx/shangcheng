...
//		console.log(arrayInfor)
		...
		if (bCheck == true && arrayInfor != null && arrayInfor.length > 0) {
			...
			var itemColumHead = $("<th class=\"th-price\" width=\"15%\">原价(元)</th><th class=\"th-stock\" width=\"21%\">批发价</th><th class=\"th-code\" width=\"10%\">库存</th>");
			itemColumHead.appendTo(trHead);
...
//					console.log(item);
					...
					var td0 = $("<td class=\"text-right inp\" style='display:none;'><input type=\"checkbox\" id=\""+priceId+"\" specId=\""+specId+"\" invenId=\""+invenIds+"\" class=\"js-default input-small radio\" value=\"1\"><div>不勾选代表此规格不参加批发</div></td>");
					if (isGroup == 1) {
