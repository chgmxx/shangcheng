...
//		console.log(arrayInfor)
        ...
        if (bCheck == true && arrayInfor != null && arrayInfor.length > 0) {
            ...
            var itemColumHead = $("<th class=\"text-right\"  width=\"21%\">是否参与</th>");
            ...
            var itemColumHead = $("<th class=\"th-price\" width=\"15%\">原价(元)</th><th class=\"th-stock\" width=\"21%\">秒杀价</th><th class=\"th-code\" width=\"10%\">库存</th>");
            itemColumHead.appendTo(trHead);
...
//					console.log(item);
                    ...
                    var td0 = $("<td class=\"text-right inp\"><input type=\"checkbox\" id=\"" + priceId + "\" specId=\"" + specId + "\" invenId=\"" + invenIds + "\" class=\"js-default input-small radio\" value=\"1\"><div>不勾选代表此规格不参加秒杀</div></td>");
                    if (isGroup == 1) {
                    ...
                    var td3 = $("<td  class='inp invNum'>" + num + "</td>");
                    td3.appendTo(tr);
                });
            }
