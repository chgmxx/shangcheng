...
public class MpGenerator {
    ...
    // 生成的包路径
    private static final  String   packagePath        = "com.gt.mall.generator.presale";
	...
	AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			...
			new StrategyConfig()
					...
					// 自定义 service 父类
					.setSuperServiceClass( "com.gt.mall.base.BaseService" )
					// 自定义 service 实现类父类
					.setSuperServiceImplClass( "com.gt.mall.base.BaseServiceImpl" )
					// 自定义 controller 父类
					.setSuperControllerClass( "com.gt.mall.base.BaseController" )
