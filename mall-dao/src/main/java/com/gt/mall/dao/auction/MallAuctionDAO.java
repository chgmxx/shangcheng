...
public interface MallAuctionDAO extends BaseMapper< MallAuction > {
     ...
     * @return 商品列表
     */
    List< Map< String,Object > > selectGoingAuctionProduct( PhoneSearchProductDTO searchProductDTO );

    /**
     * 统计正在进行的拍卖商品
     */
    int selectCountGoingAuctionProduct( PhoneSearchProductDTO searchProductDTO );
}