...
public class MallSellerNewController extends BaseController {
    ...
    public ServerResponse sellerSendIntegral( HttpServletRequest request, HttpServletResponse response, @RequestBody Map< String,Object > params ) {
        try {
            logger.info( "关注送积分接收到的参数：" + params );
