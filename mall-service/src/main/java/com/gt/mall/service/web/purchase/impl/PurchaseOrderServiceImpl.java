...
public class PurchaseOrderServiceImpl extends BaseServiceImpl<PurchaseOrderDAO, PurchaseOrder> implements PurchaseOrderService {
     ...
     */
    @Override
    public Map<String, Object> saveOrder(PurchaseOrder order, List<PurchaseOrderDetails> orderDetailsList,
                                         List<PurchaseTerm> termList, List<PurchaseCarousel> carouselList) {
