...
//        List<MallGroupBuyPrice> priceList = groupBuyPriceDAO.selectPriceByGroupId(groupBuyId);
    ...
    public int editGroupBuy(Map<String, Object> groupMap, int userId) {
        ...
        if (CommonUtil.isNotEmpty(groupMap.get("groupBuy"))) {
            MallGroupBuy groupBuy = (MallGroupBuy) JSONObject.toBean(
                    JSONObject.fromObject(groupMap.get("groupBuy")), MallGroupBuy.class);
                ...
                for (Map<String, Object> map : productList) {
                    ...
                    if (isCommission == 0 && isIntegral == 0) {
                        if (CommonUtil.isNotEmpty(map.get("groupMap"))) {
                            Map<String, Object> groupMap = (Map<String, Object>)
                                    JSONObject.toBean(JSONObject.fromObject(map.get("groupMap")), Map.class);
                        ...
                        if (CommonUtil.isNotEmpty(map.get("seckillMap"))) {
                            Map<String, Object> seckillMap = (Map<String, Object>)
                                    JSONObject.toBean(JSONObject.fromObject(map.get("seckillMap")), Map.class);
                        ...
                        if (CommonUtil.isNotEmpty(map.get("auctionMap"))) {
                            Map<String, Object> auctionMap = (Map<String, Object>)
                                    JSONObject.toBean(JSONObject.fromObject(map.get("auctionMap")), Map.class);
                        ...
                        if (CommonUtil.isNotEmpty(map.get("presaleMap"))) {
                            Map<String, Object> presaleMap = (Map<String, Object>)
                                    JSONObject.toBean(JSONObject.fromObject(map.get("presaleMap")), Map.class);
                        ...
                        if (CommonUtil.isNotEmpty(map.get("pifaMap"))) {
                            Map<String, Object> pifaMap = (Map<String, Object>)
                                    JSONObject.toBean(JSONObject.fromObject(map.get("pifaMap")), Map.class);
