...
public class PurchaseReceivablesServiceImpl extends BaseServiceImpl<PurchaseReceivablesDAO, PurchaseReceivables> implements PurchaseReceivablesService {
    ...
    @Override
    public SortedMap<Object, Object> cgPay(String url, Integer memberId, Integer busId, String termId, Double money, Double discountmoney, Double fenbi, Integer jifen, Integer discount, String paymentType, Integer orderId, Integer dvId, String disCountdepict) throws Exception {
...
//                wxPayService.memberPay(params);
    ...
    @Override
    public Map<String, Object> aliCgPay(Integer memberId, Integer busId, String termId, Double money, Double discountmoney, Double fenbi, Integer jifen, Integer discount, String paymentType, Integer orderId, Integer dvId, String disCountdepict) throws Exception {
        if (CommonUtil.isEmpty(memberId) || CommonUtil.isEmpty(money)) {
            throw new Exception();
        }
        try {
